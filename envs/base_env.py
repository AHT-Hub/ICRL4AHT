"""Abstract base environment class for multi-agent environments.

This module defines the base interface for all environments in the benchmark,
providing a standard API for reset, step, available actions, and observation/action spaces.
"""
