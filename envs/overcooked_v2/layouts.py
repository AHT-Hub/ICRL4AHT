"""Layout definitions for the OvercookedV2 environment."""
...
overcooked_v2_layouts = {
    ...
    # Adapted layouts
    "cramped_room_up": Layout.from_string(cramped_room_up),
    "cramped_room_down": Layout.from_string(cramped_room_down),
    ...
    "asymm_advantages_recipes_both": Layout.from_string(asymm_advantages_recipes_both),
