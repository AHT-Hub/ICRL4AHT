"""OvercookedV2 environment implementation.

This is the main OvercookedV2 environment class, adapted from JaxMARL.
"""
...
from jax import lax
from envs.overcooked_v2.multi_agent_env import MultiAgentEnv
...
from envs.overcooked_v2.layouts import overcooked_v2_layouts, Layout
from envs.overcooked_v2.settings import (
    DELIVERY_REWARD,
        ...
        def _get_obs_shape_single(obs_type):
            match obs_type:
                case ObservationType.DEFAULT:
                    ...
                    # Observation layers breakdown:
                    # - agent_layer: pos(1) + dir(4) + inv(2+n) = 7+n
                    # - other_agent_layers: 7+n
                    # - static_layers: 6
                    # - ingredient_pile_layers: n
                    # - ingredients_layers: 2+n
                    # - recipe_layers: 2+n
                    # - extra_layers: 1
                    # Total: 2*(7+n) + 6 + n + (2+n) + (2+n) + 1 = 25 + 5n
